...
export default {
  ...
  methods:{
      ...
      async register() {
          ...
          console.log(response,this.phone,this.password,this.name,this.email);
        },
        async login() {
            let data = {
